...
namespace persona_herencia
{
    class Persona //clase padre
    {
        ...
        public string nombrecompleto //inicio de caja de memoria 
        {
    ...
    {
        protected int Sueldo; //creacion de variable sueldo por ser docente
        public int sueldo //caja de memoria de sueldo
        {
            get { return Sueldo; }
            set { Sueldo = value; }
        }
